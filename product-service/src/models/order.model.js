...
class Order {
  static async create(orderData, client = pool) {
    const query = `
      INSERT INTO "orders" (
        order_id, user_id, order_number, total_amount, subtotal, tax_amount, 
        shipping_amount, discount_amount, currency, payment_method, payment_status, 
        shipping_method, shipping_status, order_status, tracking_number, notes, created_at, updated_at
      )
